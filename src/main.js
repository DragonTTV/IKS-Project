...
(async () => {
  try {
    ...
    clickHandler.addAudio("bhangkora", "/IKS-Project/assets/audio/bhangkora.mp3");
    clickHandler.addAudio("gogona", "/IKS-Project/assets/audio/gogona.mp3");  
    clickHandler.addAudio("ektara", "/IKS-Project/assets/audio/ektara.mp3"); 
    clickHandler.addAudio("esraj", "/IKS-Project/assets/audio/esraj.mp3");   
    clickHandler.addAudio("hudukka", "/IKS-Project/assets/audio/hudukka.mp3");
    clickHandler.addAudio("khuang", "/IKS-Project/assets/audio/khuang1.mp3");
    clickHandler.addAudio("mayurveena", "/IKS-Project/assets/audio/mayurveena.mp3");
    clickHandler.addAudio("ottu", "/IKS-Project/assets/audio/ottu.mp3");
    clickHandler.addAudio("morsing", "/IKS-Project/assets/audio/morsing.mp3"); 
    clickHandler.addAudio("khamak", "/IKS-Project/assets/audio/khamak.mp3");
